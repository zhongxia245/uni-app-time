...
Z([3,'content padding'])
Z([3,'这是一个学习的项目，从零开始搭建一个 uniapp。当前时间是：2019-11-08 22:52:34，前后一个礼拜，下班的时候学习一两个小时，目前大概是这样。'])
Z([3,'该项目需要熟悉以下几个点'])
Z([3,'1. vue 语法熟悉'])
Z([3,'2. uni app 语法熟悉'])
Z([3,'3. 异步请求处理'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'padding data-v-00676f3f'])
Z([3,'data-v-00676f3f'])
Z([3,'cu-form-group data-v-00676f3f'])
Z([3,'title data-v-00676f3f'])
Z([3,'名称'])
Z([3,'__e'])
Z(z[1])
Z([[4],[[5],[[4],[[5],[[5],[1,'input']],[[4],[[5],[[4],[[5],[[5],[[5],[1,'__set_model']],[[4],[[5],[[5],[[5],[[5],[1,'$0']],[1,'name']],[1,'$event']],[[4],[[5]]]]]],[[4],[[5],[1,'data']]]]]]]]]]])
Z([3,'倒数日名称'])
Z([[6],[[7],[3,'data']],[3,'name']])
Z([3,'cu-form-group align-start data-v-00676f3f'])
Z(z[3])
Z([3,'描述'])
Z(z[5])
Z(z[1])
Z([[4],[[5],[[4],[[5],[[5],[1,'input']],[[4],[[5],[[4],[[5],[[5],[[5],[1,'__set_model']],[[4],[[5],[[5],[[5],[[5],[1,'$0']],[1,'desc']],[1,'$event']],[[4],[[5]]]]]],[[4],[[5],[1,'data']]]]]]]]]]])
Z([3,'-1'])
Z([3,'用几句话来描述下这件事吧~~'])
Z([[6],[[7],[3,'data']],[3,'desc']])
Z(z[2])
...
Z([3,'1990-01-01'])
Z([[6],[[7],[3,'data']],[3,'date']])
Z([3,'picker data-v-00676f3f'])
Z([a,[[6],[[7],[3,'data']],[3,'date']]])
Z([3,'flex margin-tb-lg data-v-00676f3f'])
Z([[7],[3,'isEdit']])
Z(z[5])
Z([3,'cu-btn bg-red lg data-v-00676f3f'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'onDel']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([[7],[3,'loading']])
Z([3,'删除'])
Z(z[5])
Z([3,'cu-btn bg-blue lg data-v-00676f3f'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'submit']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z(z[36])
Z([a,[[2,'?:'],[[7],[3,'isEdit']],[1,'更新'],[1,'添加']]])
...
Z([3,'empty'])
Z([3,'../../static/pages/index/empty.png'])
Z([3,'empty-tip'])
Z([3,'空空如也呀，去添加一条记录吧~~'])
Z([3,'__e'])
Z([3,'cu-btn bg-blue lg text-lg shadow-blur margin-tb-lg block '])
...
Z([[7],[3,'sortlist']])
Z(z[11])
Z([3,'nav-li-wapper js-swiper'])
Z([[4],[[5],[[5],[1,'nav-li js-list']],[[2,'+'],[1,'bg-'],[[6],[[7],[3,'colorList']],[[2,'%'],[[7],[3,'index']],[[6],[[7],[3,'colorList']],[3,'length']]]]]]])
Z([3,'none'])
Z([[2,'+'],[1,'./add?index\x3d'],[[7],[3,'index']]])
Z([3,'nav-title'])
Z([a,[[2,'+'],[[2,'+'],[[6],[[7],[3,'item']],[3,'date']],[1,' - ']],[[6],[[7],[3,'item']],[3,'name']]]])
Z([3,'nav-name'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'header bg-gradual-blue'])
Z([3,'avatar'])
Z([3,'scaleToFill'])
Z([[6],[[7],[3,'data']],[3,'avatar']])
Z([3,'margin-tb-sm username'])
Z([a,[[6],[[7],[3,'data']],[3,'name']]])
Z([3,'desc'])
Z([a,[[6],[[7],[3,'data']],[3,'desc']]])
...
Z([[4],[[5],[[5],[1,'content']],[[2,'+'],[1,'bg-'],[[6],[[7],[3,'colorList']],[[2,'%'],[[2,'+'],[[2,'*'],[[7],[3,'index']],[[6],[[6],[[6],[[7],[3,'item']],[3,'$orig']],[3,'list']],[3,'length']]],[[7],[3,'i']]],[[6],[[7],[3,'colorList']],[3,'length']]]]]]])
Z([a,[[2,'+'],[[2,'+'],[[2,'+'],[1,'【'],[[6],[[7],[3,'diary']],[3,'date']]],[1,'】 - ']],[[6],[[7],[3,'diary']],[3,'name']]]])
Z([a,[[6],[[7],[3,'diary']],[3,'desc']]])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'padding data-v-6394fd7f'])
Z([3,'data-v-6394fd7f'])
Z([3,'cu-form-group data-v-6394fd7f'])
Z([3,'title data-v-6394fd7f'])
Z([3,'名称'])
Z([3,'__e'])
Z(z[1])
Z([[4],[[5],[[4],[[5],[[5],[1,'input']],[[4],[[5],[[4],[[5],[[5],[[5],[1,'__set_model']],[[4],[[5],[[5],[[5],[[5],[1,'$0']],[1,'name']],[1,'$event']],[[4],[[5]]]]]],[[4],[[5],[1,'data']]]]]]]]]]])
Z([3,'请输入名称'])
Z([[6],[[7],[3,'data']],[3,'name']])
Z([3,'cu-form-group align-start data-v-6394fd7f'])
Z(z[3])
Z([3,'签名'])
Z(z[5])
Z(z[1])
...
Z([3,'这个人很懒,什么都没有留下~~'])
Z([[6],[[7],[3,'data']],[3,'desc']])
Z([3,'flex margin-tb-lg data-v-6394fd7f'])
Z(z[5])
Z([3,'cu-btn bg-blue lg data-v-6394fd7f'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'submit']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([[7],[3,'loading']])
Z([3,'保存'])
...
var x=['./pages/about/about.wxml','./pages/editor/editor.wxml','./pages/index/add.wxml','./pages/index/index.wxml','./pages/mine/mine.wxml','./pages/mine/timeline.wxml','./pages/mine/user-form.wxml'];d_[x[0]]={}
...
var aZ=_mz(z,'view',['class',6,'data-name',1],[],e,s,gg)
_(lY,aZ)
var t1=_mz(z,'view',['bindtap',8,'class',1,'data-event-opts',2],[],e,s,gg)
_(lY,t1)
var e2=_mz(z,'view',['class',11,'data-name',1,'data-value',2],[],e,s,gg)
_(lY,e2)
var b3=_mz(z,'view',['bindtap',14,'class',1,'data-event-opts',2],[],e,s,gg)
_(lY,b3)
var o4=_mz(z,'view',['bindtap',17,'class',1,'data-event-opts',2],[],e,s,gg)
_(lY,o4)
var x5=_mz(z,'view',['bindtap',20,'class',1,'data-event-opts',2],[],e,s,gg)
_(lY,x5)
_(oX,lY)
var o6=_mz(z,'editor',['showImgToolbar',-1,'showImgSize',-1,'showImgResize',-1,'bindready',23,'bindstatuschange',1,'class',2,'data-event-opts',3,'id',4,'placeholder',5,'readOnly',6],[],e,s,gg)
_(oX,o6)
_(cW,oX)
_(oV,cW)
_(r,oV)
...
_(tEB,eFB)
_(aDB,tEB)
var bGB=_mz(z,'textarea',['bindinput',13,'class',1,'data-event-opts',2,'maxlength',3,'placeholder',4,'value',5],[],e,s,gg)
_(aDB,bGB)
_(h9,aDB)
var oHB=_n('view')
...
_(xIB,oJB)
_(oHB,xIB)
var fKB=_mz(z,'picker',['bindchange',22,'class',1,'data-event-opts',2,'end',3,'mode',4,'start',5,'value',6],[],e,s,gg)
var cLB=_n('view')
...
var oPB=_mz(z,'button',['bindtap',33,'class',1,'data-event-opts',2,'loading',3],[],e,s,gg)
var lQB=_oz(z,37,e,s,gg)
_(oPB,lQB)
_(cOB,oPB)
}
var aRB=_mz(z,'button',['bindtap',38,'class',1,'data-event-opts',2,'loading',3],[],e,s,gg)
...
_(fYB,cZB)
_(xWB,fYB)
var h1B=_mz(z,'button',['bindtap',6,'class',1,'data-event-opts',2],[],e,s,gg)
var o2B=_oz(z,9,e,s,gg)
_(h1B,o2B)
_(xWB,h1B)
_(oVB,xWB)
}
var c3B=_n('scroll-view')
c3B.attr['scrollY']=true
var o4B=_n('view')
...
var xAC=_n('view')
_rz(z,xAC,'class',15,e8B,t7B,gg)
var oBC=_mz(z,'navigator',['navigateTo',-1,'class',16,'hoverClass',1,'url',2],[],e8B,t7B,gg)
var fCC=_n('view')
_rz(z,fCC,'class',19,e8B,t7B,gg)
var cDC=_oz(z,20,e8B,t7B,gg)
_(fCC,cDC)
_(oBC,fCC)
var hEC=_n('view')
_rz(z,hEC,'class',21,e8B,t7B,gg)
var oFC=_oz(z,22,e8B,t7B,gg)
_(hEC,oFC)
_(oBC,hEC)
_(xAC,oBC)
_(b9B,xAC)
...
l5B.wxXCkey=2
_2z(z,13,a6B,e,s,gg,l5B,'item','index','index')
_(c3B,o4B)
var cGC=_n('view')
...
var tKC=_n('view')
var eLC=_mz(z,'image',['class',1,'mode',1,'src',2],[],e,s,gg)
_(tKC,eLC)
_(aJC,tKC)
var bMC=_n('view')
...
var hSC=_mz(z,'navigator',['class',10,'hoverClass',1,'url',2],[],e,s,gg)
var oTC=_n('text')
...
var aXC=_mz(z,'navigator',['class',17,'hoverClass',1,'url',2],[],e,s,gg)
var tYC=_n('text')
...
var x3C=_mz(z,'navigator',['class',24,'hoverClass',1,'url',2],[],e,s,gg)
var o4C=_n('text')
...
var o8C=_mz(z,'navigator',['class',31,'hoverClass',1,'url',2],[],e,s,gg)
var c9C=_n('text')
...
var tCD=_mz(z,'view',['bindtap',38,'class',1,'data-event-opts',2,'hoverClass',3],[],e,s,gg)
var eDD=_n('text')
...
var oHD=_mz(z,'navigator',['class',46,'hoverClass',1,'url',2],[],e,s,gg)
var fID=_n('text')
...
var xUD=_n('view')
_rz(z,xUD,'class',5,tQD,aPD,gg)
var oVD=_oz(z,6,tQD,aPD,gg)
_(xUD,oVD)
_(oTD,xUD)
var fWD=_v()
_(oTD,fWD)
...
var t5D=_n('view')
var e6D=_oz(z,13,oZD,hYD,gg)
_(t5D,e6D)
_(a4D,t5D)
var b7D=_n('view')
var o8D=_oz(z,14,oZD,hYD,gg)
_(b7D,o8D)
_(a4D,b7D)
_(l3D,a4D)
_(c1D,l3D)
...
fWD.wxXCkey=2
_2z(z,9,cXD,tQD,aPD,gg,fWD,'diary','i','i')
_(eRD,oTD)
return eRD
}
oND.wxXCkey=2
_2z(z,2,lOD,e,s,gg,oND,'item','index','index')
_(r,cMD)
return r
}
...
_(hCE,oDE)
_(cBE,hCE)
var cEE=_mz(z,'input',['bindinput',5,'class',1,'data-event-opts',2,'placeholder',3,'value',4],[],e,s,gg)
_(cBE,cEE)
_(fAE,cBE)
var oFE=_n('view')
...
_(lGE,aHE)
_(oFE,lGE)
var tIE=_mz(z,'textarea',['bindinput',13,'class',1,'data-event-opts',2,'maxlength',3,'placeholder',4,'value',5],[],e,s,gg)
_(oFE,tIE)
_(fAE,oFE)
var eJE=_n('view')
_rz(z,eJE,'class',19,e,s,gg)
var bKE=_mz(z,'button',['bindtap',20,'class',1,'data-event-opts',2,'loading',3],[],e,s,gg)
...
__wxAppCode__['pages/about/about.wxss']=setCssToHead([".",[1],"content { padding: ",[0,50],"; }\n.",[1],"content wx-view { margin-bottom: ",[0,30],"; }\n",],undefined,{path:"./pages/about/about.wxss"});    
__wxAppCode__['pages/about/about.wxml']=$gwx('./pages/about/about.wxml');

__wxAppCode__['pages/editor/editor.wxss']=setCssToHead(["@font-face { font-family: \x22iconfont\x22; src: url(\x27https://img-cdn-qiniu.dcloud.net.cn/fonts/editor-icon.ttf\x27) format(\x27truetype\x27); }\n.",[1],"iconfont { font-family: \x22iconfont\x22 !important; font-size: 16px; font-style: normal; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; }\n.",[1],"icon-redo:before { content: \x22\\E627\x22; }\n.",[1],"icon-undo:before { content: \x22\\E633\x22; }\n.",[1],"icon-indent:before { content: \x22\\EB28\x22; }\n.",[1],"icon-outdent:before { content: \x22\\E6E8\x22; }\n.",[1],"icon-fontsize:before { content: \x22\\E6FD\x22; }\n.",[1],"icon-format-header-1:before { content: \x22\\E860\x22; }\n.",[1],"icon-format-header-4:before { content: \x22\\E863\x22; }\n.",[1],"icon-format-header-5:before { content: \x22\\E864\x22; }\n.",[1],"icon-format-header-6:before { content: \x22\\E865\x22; }\n.",[1],"icon-clearup:before { content: \x22\\E64D\x22; }\n.",[1],"icon-preview:before { content: \x22\\E631\x22; }\n.",[1],"icon-date:before { content: \x22\\E63E\x22; }\n.",[1],"icon-fontbgcolor:before { content: \x22\\E678\x22; }\n.",[1],"icon-clearedformat:before { content: \x22\\E67E\x22; }\n.",[1],"icon-font:before { content: \x22\\E684\x22; }\n.",[1],"icon-723bianjiqi_duanhouju:before { content: \x22\\E65F\x22; }\n.",[1],"icon-722bianjiqi_duanqianju:before { content: \x22\\E660\x22; }\n.",[1],"icon-text_color:before { content: \x22\\E72C\x22; }\n.",[1],"icon-format-header-2:before { content: \x22\\E75C\x22; }\n.",[1],"icon-format-header-3:before { content: \x22\\E75D\x22; }\n.",[1],"icon--checklist:before { content: \x22\\E664\x22; }\n.",[1],"icon-baocun:before { content: \x22\\EC09\x22; }\n.",[1],"icon-line-height:before { content: \x22\\E7F8\x22; }\n.",[1],"icon-quanping:before { content: \x22\\EC13\x22; }\n.",[1],"icon-direction-rtl:before { content: \x22\\E66E\x22; }\n.",[1],"icon-direction-ltr:before { content: \x22\\E66D\x22; }\n.",[1],"icon-selectall:before { content: \x22\\E62B\x22; }\n.",[1],"icon-fuzhi:before { content: \x22\\EC7A\x22; }\n.",[1],"icon-shanchu:before { content: \x22\\EC7B\x22; }\n.",[1],"icon-bianjisekuai:before { content: \x22\\EC7C\x22; }\n.",[1],"icon-fengexian:before { content: \x22\\EC7F\x22; }\n.",[1],"icon-dianzan:before { content: \x22\\EC80\x22; }\n.",[1],"icon-charulianjie:before { content: \x22\\EC81\x22; }\n.",[1],"icon-charutupian:before { content: \x22\\EC82\x22; }\n.",[1],"icon-wuxupailie:before { content: \x22\\EC83\x22; }\n.",[1],"icon-juzhongduiqi:before { content: \x22\\EC84\x22; }\n.",[1],"icon-yinyong:before { content: \x22\\EC85\x22; }\n.",[1],"icon-youxupailie:before { content: \x22\\EC86\x22; }\n.",[1],"icon-youduiqi:before { content: \x22\\EC87\x22; }\n.",[1],"icon-zitidaima:before { content: \x22\\EC88\x22; }\n.",[1],"icon-xiaolian:before { content: \x22\\EC89\x22; }\n.",[1],"icon-zitijiacu:before { content: \x22\\EC8A\x22; }\n.",[1],"icon-zitishanchuxian:before { content: \x22\\EC8B\x22; }\n.",[1],"icon-zitishangbiao:before { content: \x22\\EC8C\x22; }\n.",[1],"icon-zitibiaoti:before { content: \x22\\EC8D\x22; }\n.",[1],"icon-zitixiahuaxian:before { content: \x22\\EC8E\x22; }\n.",[1],"icon-zitixieti:before { content: \x22\\EC8F\x22; }\n.",[1],"icon-zitiyanse:before { content: \x22\\EC90\x22; }\n.",[1],"icon-zuoduiqi:before { content: \x22\\EC91\x22; }\n.",[1],"icon-zitiyulan:before { content: \x22\\EC92\x22; }\n.",[1],"icon-zitixiabiao:before { content: \x22\\EC93\x22; }\n.",[1],"icon-zuoyouduiqi:before { content: \x22\\EC94\x22; }\n.",[1],"icon-duigoux:before { content: \x22\\EC9E\x22; }\n.",[1],"icon-guanbi:before { content: \x22\\ECA0\x22; }\n.",[1],"icon-shengyin_shiti:before { content: \x22\\ECA5\x22; }\n.",[1],"icon-Character-Spacing:before { content: \x22\\E964\x22; }\n.",[1],"wrapper { padding: 5px; height: 100vh; overflow: hidden; }\n.",[1],"iconfont { display: inline-block; padding: 8px 8px; width: 24px; height: 24px; cursor: pointer; font-size: 20px; -webkit-box-flex: 1; -webkit-flex: 1; -ms-flex: 1; flex: 1; text-align: center; }\n.",[1],"toolbar { -webkit-box-sizing: border-box; box-sizing: border-box; border-bottom: 0; font-family: \x27Helvetica Neue\x27, \x27Helvetica\x27, \x27Arial\x27, sans-serif; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; border-bottom: ",[0,1]," solid #ebebeb; padding-bottom: ",[0,30],"; }\n.",[1],"ql-container { -webkit-box-flex: 1; -webkit-flex: 1; -ms-flex: 1; flex: 1; -webkit-box-sizing: border-box; box-sizing: border-box; padding: 12px 15px; width: 100%; min-height: 30vh; height: auto; background: #fff; margin-top: 20px; font-size: 16px; line-height: 1.5; background-color: transparent; }\n.",[1],"ql-active { color: #06c; }\n",],undefined,{path:"./pages/editor/editor.wxss"});    
__wxAppCode__['pages/editor/editor.wxml']=$gwx('./pages/editor/editor.wxml');

__wxAppCode__['pages/index/add.wxss']=setCssToHead([".",[1],"flex .",[1],"cu-btn.",[1],"data-v-00676f3f { -webkit-box-flex: 1; -webkit-flex: 1; -ms-flex: 1; flex: 1; margin-right: ",[0,15],"; }\n.",[1],"flex .",[1],"cu-btn.",[1],"data-v-00676f3f:last-child { margin-right: 0; }\n",],undefined,{path:"./pages/index/add.wxss"});    
__wxAppCode__['pages/index/add.wxml']=$gwx('./pages/index/add.wxml');

__wxAppCode__['pages/index/index.wxss']=setCssToHead([".",[1],"page { }\n.",[1],"empty { padding: ",[0,300]," ",[0,150]," ",[0,0],"; text-align: center; }\n.",[1],"empty wx-image { height: ",[0,256],"; width: ",[0,283],"; }\n.",[1],"empty wx-button { }\n.",[1],"empty-tip { font-size: ",[0,24],"; color: #8a8a8a; }\n.",[1],"nav-list { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-flex-wrap: wrap; -ms-flex-wrap: wrap; flex-wrap: wrap; padding: 0px ",[0,40]," 0px; -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; }\n.",[1],"nav-li { padding: ",[0,30],"; border-radius: ",[0,12],"; width: 100%; margin-top: ",[0,40],"; background-image: url(data:image/png;base64,\x3d); background-size: cover; background-position: center; position: relative; z-index: 1; }\n.",[1],"nav-li::after { content: \x27\x27; position: absolute; z-index: -1; background-color: inherit; width: 100%; height: 100%; left: 0; bottom: -10%; border-radius: ",[0,10],"; opacity: 0.2; -webkit-transform: scale(0.9, 0.9); -ms-transform: scale(0.9, 0.9); transform: scale(0.9, 0.9); }\n.",[1],"nav-li.",[1],"cur { color: #fff; background: rgb(94, 185, 94); -webkit-box-shadow: ",[0,4]," ",[0,4]," ",[0,6]," rgba(94, 185, 94, 0.4); box-shadow: ",[0,4]," ",[0,4]," ",[0,6]," rgba(94, 185, 94, 0.4); }\n.",[1],"nav-title { font-size: ",[0,32],"; font-weight: 300; }\n.",[1],"nav-title::first-letter { font-size: ",[0,40],"; margin-right: ",[0,4],"; }\n.",[1],"nav-name { font-size: ",[0,28],"; text-transform: Capitalize; margin-top: ",[0,20],"; position: relative; }\n.",[1],"nav-name::before { content: \x27\x27; position: absolute; display: block; width: ",[0,40],"; height: ",[0,6],"; background: #fff; bottom: 0; right: 0; opacity: 0.5; }\n.",[1],"nav-name::after { content: \x27\x27; position: absolute; display: block; width: ",[0,100],"; height: 1px; background: #fff; bottom: 0; right: ",[0,40],"; opacity: 0.3; }\n.",[1],"nav-name::first-letter { font-weight: bold; font-size: ",[0,36],"; margin-right: 1px; }\n.",[1],"nav-li wx-text { position: absolute; right: ",[0,30],"; top: ",[0,30],"; font-size: ",[0,52],"; width: ",[0,60],"; height: ",[0,60],"; text-align: center; line-height: ",[0,60],"; }\n.",[1],"text-light { font-weight: 300; }\n.",[1],"nav-li-wapper { width: 100%; }\n",],undefined,{path:"./pages/index/index.wxss"});    
__wxAppCode__['pages/index/index.wxml']=$gwx('./pages/index/index.wxml');

__wxAppCode__['pages/mine/mine.wxss']=setCssToHead([".",[1],"header { padding: ",[0,40]," ",[0,120],"; text-align: center; line-height: 1.5; }\n.",[1],"avatar { width: ",[0,160],"; height: ",[0,160],"; border-radius: 100%; border: ",[0,4]," solid #ffffff; }\n.",[1],"username { font-size: ",[0,34],"; }\n.",[1],"desc { overflow: hidden; display: block; -o-text-overflow: ellipsis; text-overflow: ellipsis; overflow: hidden; white-space: nowrap; }\n",],undefined,{path:"./pages/mine/mine.wxss"});    
__wxAppCode__['pages/mine/mine.wxml']=$gwx('./pages/mine/mine.wxml');

__wxAppCode__['pages/mine/timeline.wxss']=undefined;    
__wxAppCode__['pages/mine/timeline.wxml']=$gwx('./pages/mine/timeline.wxml');

__wxAppCode__['pages/mine/user-form.wxss']=setCssToHead([".",[1],"flex .",[1],"cu-btn.",[1],"data-v-6394fd7f { -webkit-box-flex: 1; -webkit-flex: 1; -ms-flex: 1; flex: 1; margin-right: ",[0,15],"; }\n.",[1],"flex .",[1],"cu-btn.",[1],"data-v-6394fd7f:last-child { margin-right: 0; }\n",],undefined,{path:"./pages/mine/user-form.wxss"});    
__wxAppCode__['pages/mine/user-form.wxml']=$gwx('./pages/mine/user-form.wxml');
